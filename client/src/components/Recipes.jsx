        ...
        <div className="row mt-5">
            <div className="col-md-4">
                ...
                {recipe.extendedIngredients.map(ingredient => (
                    <p className="recipes-p" key={ingredient.id}>{ingredient.measures.metric.amount} {ingredient.measures.metric.unitLong} {ingredient.name}</p>
                ))}
            ...
            <div className="col-md-8">
                ...
                {recipe.analyzedInstructions[0].steps.map(step => (
                    <div key={step.number}>
                        ...
                        <p className="recipes-p">{step.step}</p>
                    </div>
                ))}
                </div>
            </div>
